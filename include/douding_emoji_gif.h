/**
 * @file douding_emoji_gif.h
 * @brief douding机器人GIF表情资源组件
 *
 * 这个头文件声明了douding机器人的6个GIF表情资源，用于在LVGL显示屏上显示动态表情。
 *
 * @version 1.0.2
 * @date 2024
 *
 ...
 */
const lv_image_dsc_t* douding_emoji_gif_get_by_name(const char* name);
